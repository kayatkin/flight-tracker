...
const HistoryView: React.FC<HistoryViewProps> = ({ 
  ...
  return (
    <div className={styles.container}>
      {/* Аккордеон управления доступом - показываем ВСЕГДА для владельцев */}
      {!isGuest && (
            ...
            <div className={styles.accessContent}>
              <div className={styles.accessButtonsGroup}>
                ...
                <button
                  ...
                  style={flights.length === 0 ? { opacity: 0.7, cursor: 'not-allowed' } : {}}
                >
              ...
              {/* Список выданных приглашений - показываем только если есть перелеты */}
              {showSessionsList && userId && flights.length > 0 && (
